...
//        System.out.println(my_static);
        x.countStatic();
//        System.out.println(my_static);
        int[] expected_values = {0,1,2,3}; //might need to fix
    ...
    public String toString(){
        ...
        return (this.name); //idk if this is right
    }
    ...
    public int compareTo(Silly other) {
         ...
         */
        return Integer.compare(thisNameLen, otherNameLen);
